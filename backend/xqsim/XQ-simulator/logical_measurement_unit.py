...
class logical_measurement_unit:
    def __init__(self, unit_stat, config):
        ...
        self.pf_ready = False
        # ============================================================================
        # [QuStitch拡張] ungated_dqmeas_latch フラグ（オプトイン、デフォルトは上流と同一挙動）
        # dqmeasラッチはmeasopでゲートされており、コンテキスト外に到着した1サイクルの
        # dqmeas_validパルスは失われる。有効時はaqmeasと同様の無条件ラッチにする。
        # ============================================================================
        self.ungated_dqmeas_latch = False
        # ============================================================================
        # [QuStitch拡張] ここまで
        # ============================================================================
    ...
    def update_registers(self):
        ...
        if self.input_aqmeas_valid:
            ...
            pass
        # ============================================================================
        # [QuStitch拡張] ungated_dqmeas_latch: 条件に「self.ungated_dqmeas_latch or」を追記
        # （上流は measop によるゲートのみ）
        # ============================================================================
        if self.input_dqmeas_valid and \
           (self.ungated_dqmeas_latch or
